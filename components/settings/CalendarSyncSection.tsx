...
export function CalendarSyncSection({ onSavingStateChange, onSaveSuccess }: CalendarSyncSectionProps) {
  ...
  return (
    <View style={styles.section}>
      ...
      <Text style={styles.settingsHelpText}>Please manage calendars on the website.</Text>
      {/* Keep connection status toggles hidden on mobile, but allow event color controls. */}
      {true ? (
              ...
              {data?.connected ? (
                <>
                  <View style={styles.settingsBlock}>
                    <Text style={styles.rowLabel}>Event color</Text>
